...
import { MapPin, Phone, Mail, Instagram, Youtube, Facebook, Twitter, Send } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          >
            ...
            <div className="flex gap-4 flex-wrap">
              <a
                href="https://www.instagram.com/autolink.ethiopia/"
                target="_blank"
              ...
              <a
                href="https://t.me/autolinkethiopia"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-primary/20 hover:bg-primary/10 hover:border-primary/60 transition-all group"
              >
                <Send className="w-5 h-5 text-white/60 group-hover:text-primary transition-colors" />
              </a>
              <a
                href="#"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/people/AutoLink-Ethiopia/61581005979222/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-primary/20 hover:bg-primary/10 hover:border-primary/60 transition-all group"
              >
