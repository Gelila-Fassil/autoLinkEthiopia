...
const Hyperspeed: React.FC<HyperspeedProps> = ({
    ...
    effectOptions = {
        ...
        colors: {
            ...
            background: 0x0a0a0a,
            shoulderLines: 0xbba14f,
            brokenLines: 0xbba14f,
            leftCars: [0xbba14f, 0x8e7a3a, 0xd4c38d],
            rightCars: [0xbba14f, 0x5e5127, 0xfceabb],
            sticks: 0xbba14f
        }
    }
}) => {
    ...
    return (
        <div
            ref={hyperspeedRef}
            className={cn("hyperspeed-container", className)}
        />
    );
};
